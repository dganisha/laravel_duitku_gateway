          ...
          <div class="box box-primary">
            ...
            <form role="form">
            	@csrf
              	<div class="box-body">
	                ...
	                <div class="form-group">
	                  ...
	                  <input type="text" required="" value="{{ $orders['user_buy'] }}" class="form-control" disabled="">
	                </div>
	                <div class="form-group">
	                  <label>Harga</label>
	                ...
	                <div class="form-group">
	                  ...
	                  <a href="{{ $orders['duitku_payment_url'] }}">{{ $orders['duitku_payment_url'] }}</a>
              ...
              <div class="box-footer">
                <a href="/admin_transaction" type="button" class="btn btn-primary">Kembali</a>
              </div>
            </form>
          </div>
        </div>
